<template lang="pug">
    ...
    .auth
      .auth__wrapper
        form(class="auth__form" v-on:submit.prevent="submit")
          .auth__title
          ...
          .auth__row
            label.auth__label Логин
              ...
              input(class="auth__input" type="text" placeholder="login" v-model="user.login")
            .error-box(style="color:red") {{ validation.firstError('user.login') }}
          .auth__row
            label.auth__label Пароль
              .auth__icon.auth__icon--password
              input(class="auth__input" type="password" placeholder="password" v-model="user.password")
