                    ...
                    .new-work__info
                        ...
                        .add-form__row
                            .add-form__column.add-form__column--buttons
                                ...
                                button(type="submit" @click.prevent="editCurWork").add-button Сохранить
...
<script> 
    ...
    export default {
        ...
        methods: {
            ...mapActions('works', ['editWork', 'addButtonClicked']),
            ...
            editCurWork(){
                ...
                let editedWork = [workData, this.editedWork.id];
        ...
        mounted(){
            ...
            this.work.title = this.editedWork.title;
            this.work.link = this.editedWork.link;
            this.work.description = this.editedWork.description;
            this.renderedPhoto = baseUrl+this.editedWork.photo;
        }
    }
</script>
