                ...
                form.group__form
                  .group__row.group__row--name.active
                    .group__input.group__input--name
                      input(type="text" name="GroupTitle" placeholder="Название новой группы").group__input-name
                    .group__buttons
                  ...
                  .group__row.group__row--skills
                    ...
                    .group__add-cells
                      .group__input.group__input--cell-name
                        input(type="text" name="GroupItem" placeholder="Новый навык").group__cell-name
                      .group__input.group__input--value
                        input(type="number" name="GroupItemValue" value="100").group__cell-value
                      .group__add
            ...
            li.groups__item
              .group
                form.group__form
                  .group__row.group__row--name.active
                    .group__input.group__input--name
                      input(type="text" name="GroupTitle" placeholder="Название новой группы" value="Workflow").group__input-name
                    .group__buttons
                            .group__buttons-active
                              button.group__button.group__button--edit                     
                              button.group__button.group__button--delete 
            ...
            .admin-addwork__wrapper
              .works
                ul.works__list
                  ...
                  li.works__item
                    .works__item-picture
                      img(src='../images/content/previews/1.jpg').works__item-img
                      .tags.tags--work
                        .tags__list
                            .tags__item 
                              a.tags__close Html
                  ...
                  li.recall__item
                    .recall__item-wrapper
                      .recall__item-author
                        .recall__avatar
                          .avatar
                            img(src='../images/content/reviews/1.jpg').avatar__img
                        .recall__author-info
